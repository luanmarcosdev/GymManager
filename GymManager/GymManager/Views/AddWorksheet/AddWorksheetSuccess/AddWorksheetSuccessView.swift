...
class AddWorksheetSuccessView: UIView {

    //MARK: Delegate
    
    private weak var delegate: AddWorksheetSuccessViewDelegate?
    
    func setDelegate(delegate: AddWorksheetSuccessViewDelegate?){
    ...
    lazy var subtitleLabel: UILabel = {
        let lb = UILabel()
        lb.translatesAutoresizingMaskIntoConstraints = false
        lb.text = "Mantenha suas fichas atualizadas e não dependa mais de papel."
