...
class EditGoalSuccessView: UIView {

    //MARK: Delegate
    
    private weak var delegate: EditGoalSuccessViewDelegate?
    
    func setDelegate(delegate: EditGoalSuccessViewDelegate?){
    ...
    lazy var titleLabel: UILabel = {
        ...
        lb.text = "Meta alterada com sucesso!"
        lb.numberOfLines = 0
    ...
    lazy var subtitleLabel: UILabel = {
        let lb = UILabel()
        lb.translatesAutoresizingMaskIntoConstraints = false
        lb.text = "Continue focado na sua meta e alcance os resultados almejados."
